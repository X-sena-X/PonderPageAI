...
export const Features = () => {
    const data: Array<DataType> = [
        ...
        },
        {
            ...
            content:
                "Harness the power of AI to comprehensively analyze any uploaded text.",
    ...
    return (
        <SpotlightContainer>
            <div
                className=" w-full mx-auto grid gap-10 lg:grid-cols-3 items-start lg:max-w-none group"
                data-spotlight
            >
                {data.map((item, i) => {
                    return (
                        <div
                            key={i}
                            className="relative lg:h-full bg-slate-800 rounded-3xl p-px before:absolute before:w-80 before:h-80 before:-left-40 before:-top-40 before:bg-slate-400 before:rounded-full before:opacity-0 before:pointer-events-none before:transition-opacity before:duration-500 before:translate-x-[var(--mouse-x)] before:translate-y-[var(--mouse-y)] before:group-hover:opacity-100 before:z-10 before:blur-[100px] after:absolute after:w-96 after:h-96 after:-left-48 after:-top-48 after:bg-indigo-500 after:rounded-full after:opacity-0 after:pointer-events-none after:transition-opacity after:duration-500 after:translate-x-[var(--mouse-x)] after:translate-y-[var(--mouse-y)] after:hover:opacity-10 after:z-30 after:blur-[100px] overflow-hidden"
                        >
                            <div className="relative h-full bg-indigo-800 dark:bg-slate-900 p-6 pb-2 lg:pb-6  rounded-[inherit] z-20 overflow-hidden">
                                <div
                                ...
                                <div className="flex flex-col h-full items-center text-center">
                                    ...
                                    <div className="grow mb-5">
                                        <h2 className="text-base lg:text-xl text-slate-200 font-bold mb-1">
                                            {item.title}
                                        </h2>
